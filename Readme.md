...
## Options
  ...
  - `transformBody` when set to a function, bodyparse will use this function to parse request body instead of default parse modules.
...
// transformBody
var body = await parse(req, {
  transformBody: function(reqBodyStr) {
