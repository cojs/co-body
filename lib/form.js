...
module.exports = async function(req, opts) {
   ...
   */
  if (opts.convertEmptyStringsToNull) {
    queryString.decoder = function(str, defaultDecoder, charset, type) {
      const value = defaultDecoder(str, defaultDecoder, charset, type);
      if (type === 'value' && value === '') {
        return null;
      }
      return value;
